...
Taking a look at the above graph, there has been an increase in health searches every year, except for a slight decrease of `r abs(searches_by_year[which(searches_by_year$year == "2010"), 3])` searches from 2009 - 2010. The biggest increase in search happened between 2010 - 2011, with an increase of `r searches_by_year[which(searches_by_year$year == "2011"), 3]` searches.
